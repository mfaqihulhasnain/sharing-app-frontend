...
export function TopBar({ onlineCount, onQuickUpload }) {
  return (
    <Card className="sticky top-4 z-20 rounded-[30px] border-white/80 bg-card-strong/90 px-4 py-4 shadow-[0_20px_50px_rgba(33,54,88,0.12)] sm:px-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex items-start gap-4">
          <motion.div
            initial={{ opacity: 0, scale: 0.92 }}
            animate={{ opacity: 1, scale: 1 }}
            className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[linear-gradient(145deg,#2d74ff,#5fcbff)] text-white shadow-[0_18px_38px_rgba(45,116,255,0.28)]"
          >
