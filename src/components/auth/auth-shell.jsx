...
import { CheckCircle2, Grid2x2Check } from "lucide-react";
    ...
    <div className="relative h-dvh overflow-hidden px-4 py-4 sm:px-5 sm:py-5 lg:px-6 lg:py-6 [@media(max-height:780px)]:px-3 [@media(max-height:780px)]:py-3">
      ...
      <div
        className={cn(
          ...
          showSidebar ? "max-w-6xl lg:grid-cols-[minmax(0,1fr)_470px]" : "max-w-[470px]",
        )}
      >
        {showSidebar ? (
        ...
        <div className="flex h-full items-center justify-center">
          <Card className="w-full max-w-[470px] rounded-[28px] border-line/90 bg-card-strong px-5 py-6 sm:px-7 sm:py-7 [@media(max-height:860px)]:px-4 [@media(max-height:860px)]:py-4">
            <div className="space-y-5 [@media(max-height:860px)]:space-y-3">
              <div className="space-y-3 [@media(max-height:860px)]:space-y-2">
                <Link
                  href="/"
                ...
                <div className="space-y-1 [@media(max-height:860px)]:space-y-0.5">
                  <h1 className="text-2xl font-semibold tracking-tight text-foreground [@media(max-height:860px)]:text-[1.35rem]">
                    {title}
                  </h1>
